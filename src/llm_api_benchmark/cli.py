...
def run_benchmark_cli():
    ...
    single_parser.add_argument(
        "--api_url", default="https://api.openai.com/v1/chat/completions", help="API端点URL"
    )
    ...
    single_parser.add_argument(
        "--api_type",
        default="openai",
        choices=["openai", "claude", "azure", "gemini"],
...
def legacy_cli():
    ...
    if (
        ...
        and not sys.argv[1].startswith(("single", "batch", "report"))
    ):
        # 在命令之前插入"single"
